# The GRC Engineering Cheat Sheet [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
This README is the canonical content source for the live cheat sheet at **[cheatsheet.grc.engineering](https://cheatsheet.grc.engineering)** — the site fetches this file at runtime. It also doubles as an [Awesome List](https://awesome.re) of curated GRC Engineering resources. To contribute, edit the relevant section below and open a PR (see [Contributing](#contributing)).
...
[CC0](LICENSE) — to the extent possible under law, contributors have waived all copyright and related rights to this list.
